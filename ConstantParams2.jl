# 2nd edition of constants (included NFkB noncanonical pathway)
# Define global constants for model
#---------------------------------------------
const ANTIGEN_DOSE = 0.0;   # 0.03 for high dose of BCR, 0.01nM and 0.003nM for medium & low dose of a-BCR
const CD40L_DOSE = 10;   # 100nM for high dose and 10nM, 3nM for medium and low dose
