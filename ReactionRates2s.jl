# 2nd edition of reaction rate parameters (added params for NFkB noncanonical pathway) w/ simplified Apoptosis module
include("ConstantParams2s.jl");
...
function setAllRates!(rates)
    ...
    # 14 : activated TAK1 (activation=105000.0 w/o CBM or 1050.0 w/ CBM)
    setParams!((@view rates[ATAK1, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=24900.0/1000, synthesis=56160.0/140, translation=0, basaldecay=0, decay=0, association=0, dissociation=0, activation=105000.0, deactivation=258600.0, transport_in=0, transport_out=0);
    ...
    # 01 : Bcl2t
    setParams!((@view rates[BCL2T, 1:end]), initialConc=2000, scale=1, basalsynthesis=0, synthesis=480, translation=0, basaldecay=0.3, decay=0, association=0, dissociation=0, activation=0.01, deactivation=0, transport_in=0, transport_out=0);
    # 02 : Bcl2
    setParams!((@view rates[BCL2, 1:end]), initialConc=30000, scale=1, basalsynthesis=0, synthesis=0, translation=18.42, basaldecay=0.693147, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    #--------------------------------------------
    # MODULE 2: CASPASE 8 module (initiator caspase) species :
    # 03 : pC8
    setParams!((@view rates[PC8, 1:end]), initialConc=10000, scale=1, basalsynthesis=14011.14402, synthesis=0, translation=0, basaldecay=0.693147, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 04 : C8 (tune activation to adjust anti-apotic strength of Bcl2)
    setParams!((@view rates[C8, 1:end]), initialConc=0, scale=1, basalsynthesis=0.000036, synthesis=0.000036, translation=0, basaldecay=6.9314718, decay=0, association=0, dissociation=0, activation=0.0036, deactivation=0, transport_in=0, transport_out=0);
    #--------------------------------------------
    # MODULE 3: MOMP (pore-forming and transporting) species :
    # 05 : Mito
    setParams!((@view rates[MITO, 1:end]), initialConc=500000, scale=1, basalsynthesis=0, synthesis=0, translation=0, basaldecay=0, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 06 : MOMP (tune deactivation to adjust pro-apotic strength of Bcl2)
    setParams!((@view rates[MOMP, 1:end]), initialConc=0, scale=1, basalsynthesis=0, synthesis=0, translation=0, basaldecay=3.6, decay=0, association=0, dissociation=0, activation=0.0036, deactivation=0.36, transport_in=0, transport_out=0);
    #--------------------------------------------
    # MODULE 4: CASPASE 3 module (effector caspase) species :
    # 07 : pC3
    setParams!((@view rates[PC3, 1:end]), initialConc=10000, scale=1, basalsynthesis=416569.242, synthesis=0, translation=0, basaldecay=0.693147, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 08 : C3
    setParams!((@view rates[C3, 1:end]), initialConc=0, scale=1, basalsynthesis=0, synthesis=0.036, translation=0, basaldecay=6.9314718, decay=0, association=0, dissociation=0, activation=0.000036, deactivation=0, transport_in=0, transport_out=0);
    #--------------------------------------------
    # MODULE 5: CASPASE 6 feedback module species :
    # 09 : pC6
    setParams!((@view rates[PC6, 1:end]), initialConc=10000, scale=1, basalsynthesis=416569.242, synthesis=0, translation=0, basaldecay=0.693147, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 10 : C6
    setParams!((@view rates[C6, 1:end]), initialConc=0, scale=1, basalsynthesis=0, synthesis=0, translation=0, basaldecay=6.9314718, decay=0, association=0, dissociation=0, activation=0.000036, deactivation=0, transport_in=0, transport_out=0);
    #--------------------------------------------
    # MODULE 6: cell death species :
    # 11 : PARP
    setParams!((@view rates[PARP, 1:end]), initialConc=1000000, scale=1, basalsynthesis=694271.958, synthesis=0, translation=0, basaldecay=0.693147, decay=0, association=0, dissociation=0, activation=0, deactivation=0.0036, transport_in=0, transport_out=0);
    # 12 : cPARP
    setParams!((@view rates[CPARP, 1:end]), initialConc=0, scale=1, basalsynthesis=0, synthesis=0, translation=0, basaldecay=4.1588832, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
