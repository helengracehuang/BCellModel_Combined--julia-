# reaction rate parameters for sensitivity analysis
include("ConstantParamsSensitivity.jl");
...
function setAllRates!(rates)
    ...
    setParams!((@view rates[DEATH_TIME, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
    setParams!((@view rates[DIV0_TIME, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
