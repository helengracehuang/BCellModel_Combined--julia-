# 2nd edition of main (added utilities to solve ODE separately from NFkB model) w/ simplified apoptosis module
...
#--------------------------------------------
include("ReactionRates2s.jl");
include("HelperFunctions.jl");

include("ODE_Receptor2.jl");
include("ODE_NFkB3.jl");
include("ODE_Apoptosis2s.jl");
